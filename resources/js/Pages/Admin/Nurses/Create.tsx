...
export default function Create({ units }: { units: Unit[] }) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <div>
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">Add Nurse Staff</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Create a login account and professional profile.</p>
                </div>
            }
        >
